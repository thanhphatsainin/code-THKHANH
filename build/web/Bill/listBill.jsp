                ...
                <div class="dashboard">
                    ...
                    <div class="right">
                        <div class="right__content">
                            ...
                            <!--<div class="left_user" name="name">${newUser.name}</div>--> 
                            <div class="left_user" name="name">${sessionScope.nameUser}</div> 
                            <p class="right__desc">Bảng điều khiển</p>
                            <div class="right__cards">
                                <a class="right__card" href="http://localhost:39639/listProduct">
                                        ...
                                        <c:forEach items="${listBill}" var="bill" >
                                            <tr>
                                                ...
                                                <td data-label="Hình ảnh" style="text-align: center;">
                                                    ...
                                                    <c:forEach items="${bill.order.cart.getListProCarts()}" var="procart" >
                                                        <div><img style="width: 50px;height: 50px; border-radius: 100%; object-fit: cover;" src="/static/admin/images/${procart.product.getImage()}" alt=""></div>
                                                        </c:forEach>
                                                </td>
                                                <td>
                                                    <c:forEach items="${bill.order.cart.getListProCarts()}" var="procart" >
                                                ...
                                                <td>${bill.total}</td>
                                                <td>${bill.status}</td>
                                                <td><a href="editBill?billId=${bill.id}">Edit</a></td>
                                                <!--<td><a href="removeBill?billId=${bill.id}">Remove</a></td>-->
                                            </tr>
                                        </c:forEach>
                                    </table>
                                </div>
