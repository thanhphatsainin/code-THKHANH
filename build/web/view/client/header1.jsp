		...
		<div class="container">
			<div class="top-info">
				...
				<div class="pull-right">
					...
					<ul>
						<li><a href="/view/client/login.jsp">Xin Chào ${sessionScope.nameUser}</a></li>
							...
							<nav class="menu-primary visible-lg visible-md">
								<ul>
									...
									<li class="main-menu-item menu-item-has-children"><a href="/view/client/gioithieu.jsp">Giới thiệu</a></li>
                                                                        <li class="main-menu-item menu-item-has-children"><a href="http://localhost:39639/allSanpham">Sản phẩm</a>
										<ul class="sub-menu">
									...
									<li class="main-menu-item menu-item-has-children"><a href="" class="">Bộ sưu tập</a>
										<ul class="sub-menu ">
											<li><a href="http://localhost:39639/listProductFour">Summer 2020</a></li>
