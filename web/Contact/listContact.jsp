                        ...
                        <div class="right__content">
                            <div class="right__table">
                                ...
                                <div class="right__tableWrapper">
                                    ...
                                    <h1><center>List Contact</center></h1>
                                    ...
                                    <table border = "1" style = "border-collapse: collapse;" width = "80%" align="center">
                                        <tr>
                                            ...
                                            <th>Phone</th>
                                            <th>Hottline</th>
                                            <th colspan="2"><a href = "Contact/addContact.jsp">ADD NEW Contact</a></th>
                                        ...
                                        <c:forEach items="${listContact}" var="contact" >
                                            <tr>
                                                ...
                                                <td>${contact.email}</td>
                                                <td>${contact.sdt}</td>
                                                <td>${contact.hottline}</td>
                                                <td><a href="editContact?contactId=${contact.id}">Edit</a></td>
                                                <td><a href="removeContact?contactId=${contact.id}">Remove</a></td>
                                            </tr>
                                        </c:forEach>
                                    </table>
                                </div>
