                    ...
                    <c:forEach items="${listAllProduct}" var="product" >
                        <div class="item" >
                            <div class="evo-product-block-item"> 
                                <div class="box-image"> 
                                    <a href="click?productId=${product.id}" class="evo-image-pro product-item-photo" title="">
                                ...
                                <div class="product-item-details">
                                    ...
                                    <h3 class="product-item-name">
                                        <a href="click?productId=${product.id}">${product.name}</a> 
                                    </h3> 
                                        <%-- <a href="cartServlet?productId=${product.id}" style="color: red">Add To Cart</a> --%>
                                </div> 
                            </div>
                        </div>
                    </c:forEach>
