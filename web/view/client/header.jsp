        ...
        <div class="top-info">
            ...
            <div class="pull-right">
                <ul>
                    ...
                    <li><a href="/view/client/login.jsp"><%
                        String name = (String) session.getAttribute("nameUser");
                        if (name == null) {
                            out.print("Đăng Nhập");
                        }
                            %></a></li>
                    <li><a href="/view/client/signup.jsp"><%
                        if (name == null) {
                            out.print("Đăng Ký");
                        }
                            %></a></li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="menu">
                        <nav class="menu-primary visible-lg visible-md">
                            <ul>
                                <li class="main-menu-item current-menu-item current_page_item menu-item-home"><a href="http://localhost:39639/listAll" class="">Trang chủ</a></li>
                                <li class="main-menu-item menu-item-has-children"><a href="/view/client/gioithieu.jsp">Giới thiệu</a></li>
                                <li class="main-menu-item menu-item-has-children"><a href="http://localhost:39639/view/client/allSanpham">Sản phẩm</a>
<!--                                    <ul class="sub-menu">
                                ...
                                <li class="main-menu-item menu-item-has-children"><a href="" class="">Bộ sưu tập</a>
                                    <ul class="sub-menu ">
                                        <li><a href="http://localhost:39639/view/client/listProductFour">Summer 2020</a></li>
<!--                                        <li><a>A Pretty Comback</a></li>-->
                ...
                <div class="col-md-3">
                    <div class="header__cart d-md-block d-lg-block d-none">
                        <a href="/view/client/listCarts" title="Giỏ hàng ">
                    ...
                    <div class="header__search hidden-xs hidden-sm">
                        ...
                        <form class="search-form" method="POST" id="searchform" action="searchProduct">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" name="key" type="text" value="Tìm kiếm" >
                                    <div class="input-group-btn">
                                        <button class="btn buttom-search" type="submit">a</button>
                                    </div>
                                </div>
                            </div>
                        </form>						
