                        ...
                        <div class="right__content">
                            <div class="right__table">
                                ...
                                <div class="right__tableWrapper">
                                    <form method="POST" action="editProductAction">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>Price Init </td>
                                                <td><input type="text" name="priceInit" value = "${productUpdate.priceInit}" ></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="desLong" value = "${productUpdate.desLong}"></td>
                                            </tr>
