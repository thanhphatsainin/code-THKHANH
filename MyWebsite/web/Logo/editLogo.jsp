                        ...
                        <div class="right__content">
                            <div class="right__table">
                                ...
                                <div class="right__tableWrapper">
                                    <form method="POST" action="editLogoAction">

                                        <h1 align="center">Edit Logo</h1>
                                        <table>
                                            <tr>
                                                <td>ID: </td>
                                                <td><input type="text" name="id" value = "${logoUpdate.id}" readonly="true"></td>
                                            </tr>


                                            <tr>
                                                <td>Image </td>
                                                <td><input type="text" name="image" value = "${logoUpdate.image}"</td>
                                            </tr>

                                            <tr>
                                                <td>Name: </td>
                                                <td><input type="text" name="name" value = "${logoUpdate.name}"></td>
                                            </tr>
