                        ...
                        <div class="right__content">
                            <div class="right__table">
                                ...
                                <div class="right__tableWrapper">
                                    <form method="POST" action="editContactAction">

                                        <h1 align="center">Edit Contact</h1>
                                        <table>
                                            <tr>
                                                <td>ID: </td>
                                                <td><input type="text" name="id" value = "${contactUpdate.id}" readonly="true"></td>
                                            </tr>

                                            <tr>
                                                <td>Address: </td>
                                                <td><input type="text" name="address" value = "${contactUpdate.address}"></td>
                                            </tr>

                                            <tr>
                                                <td>Email </td>
                                                <td><input type="text" name="email" value = "${contactUpdate.email}"</td>
                                            </tr>

                                            <tr>
                                                <td>Phone </td>
                                                <td><input type="text" name="sdt" value = "${contactUpdate.sdt}"></td>
                                            </tr>

                                            <tr>
                                                <td>Hottline </td>
                                                <td><input type="text" name="hottline" value = "${contactUpdate.hottline}"></td>
                                            </tr>
